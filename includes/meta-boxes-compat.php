...
{
    global $epl_settings;
    $opts_property_status = apply_filters(
        'epl_opts_property_status_filter', array(
    ...
    $opts_property_authority = apply_filters(
        'epl_property_authority_filter', array(
    ...
    $opts_property_exclusivity = apply_filters(
        'epl_opts_property_exclusivity_filter', array(
        'exclusive'    =>    __('Exclusive', 'epl-wpimport'),
        'open'        =>    __('Open', 'epl-wpimport')
        )
    );
    $opts_property_com_authority = apply_filters(
        'epl_opts_property_com_authority_filter', array(
    ...
    $opts_area_unit = apply_filters(
        'epl_opts_area_unit_filter', array(
    ...
    $opts_rent_period = apply_filters(
        'epl_opts_rent_period_filter', array(
    ...
    $opts_property_com_listing_type = apply_filters(
        'epl_opts_property_com_listing_type_filter', array(
        'sale'        =>    __('Sale', 'epl-wpimport'),
        'lease'        =>    __('Lease', 'epl-wpimport'),
        'both'        =>    __('Both', 'epl-wpimport')
        )
    );
    $opts_property_com_tenancy = apply_filters(
        'epl_opts_property_com_tenancy_filter', array(
        'unknown'    =>    __('Unknown', 'epl-wpimport'),
        'vacant'    =>    __('Vacant', 'epl-wpimport'),
        'tenanted'    =>    __('Tenanted', 'epl-wpimport')
        )
    );
    $opts_property_com_property_extent = apply_filters(
        'epl_opts_property_com_property_extent_filter', array(
