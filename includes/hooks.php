...
function epl_wpimport_extensions_options_filter( $epl_fields = null ) {
	...
	$intro .= '<p>' . __(
		...
		This also performs a similar check with the modified image time allowing the data to update and not them images, greatly improving import performance.', 'epl-wpimport'
	) . '</p>';
